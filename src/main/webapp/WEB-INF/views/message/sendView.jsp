											...
											<div class="profile-head__id">
												...
												<div>
													<div class="profile-head__name">
														<a name="view">보내는 사람 : ${sendView.message_user1}</a>
													</div>
													<div class="message__title">
														<a name="view">${sendView.message_title}</a>
													</div>
												</div>
											</div>
											<div class="date">
												<a name="view">${sendView.message_sdate}</a>
											</div>
										</div>
									</div>
									<div class="preview-respond__content" style = "height : 600px">
										<a name="view">${sendView.message_content}</a>
									</div>
								</div>
								<a href = "deleteMessage.do?message_no=${sendView.message_no}&del=2">삭제</a>
							</form>
